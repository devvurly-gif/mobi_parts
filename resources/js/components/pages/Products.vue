              ...
              <div class="flex items-center space-x-4">
                ...
                <div class="flex space-x-2">
                  <button 
                    ...
                    class="inline-flex items-center justify-center text-green-600 hover:bg-green-600 hover:text-white hover:shadow-md hover:scale-105 transition-all duration-200 p-2 rounded-md"
                    title="Manage Images"
                  >
